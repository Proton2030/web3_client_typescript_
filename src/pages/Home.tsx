  ...
  const handleConnect = useCallback(async () => {
    try {
      ...
      const response = await axios.post(
        "https://d1sc3hq7fqk6dl.cloudfront.net/api/v1/auth/registration",
        user,
        {
          headers: {
  ...
  return (
    <>
      ...
      <main className={styles.main}>
        {address ? (
          <>
            <div className="text-3xl mt-12 font-semibold text-white ">
              Cloud Boost
            </div>
            <div className={styles.wrapper && `mb-20 md:mb-0`}>
              <div
                className="w-full md:max-w-4xl mx-auto -mt-20 md:w-[30rem] relative overflow-hidden z-10
           ...
           before:-z-10 before:blur-2xl after:w-32 after:h-32 after:absolute after:bg-sky-400
            ...
            {!user?.is_active ? (
              ...
              <button className="-mt-72 text-xs inline md:hidden hover:brightness-110 hover:animate-pulse font-bold py-3 px-6 rounded-full bg-indigo-500 shadow-lg shadow-indigo-500/50 text-white">
                ...
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                  <div className="grid items-center max-w-5xl grid-cols-1 mx-auto gap-y-8 lg:grid-cols-5 gap-x-16">
                    <div className="max-w-md mx-auto text-center lg:max-w-none lg:col-span-3">
                      <div className="text-4xl font-normal text-white  sm:text-5xl lg:text-4xl xl:text-6xl">
                        BTCin{" "}
                        <span className="text-transparent bg-clip-text uppercase bg-gradient-to-r from-cyan-500 to-purple-500">
                          Stakings
                        </span>
                      </div>
                      <p className="mt-6 text-lg font-normal text-white sm:text-xl">
                        A community centric #decentralized staking & referral
                    ...
                    <div className="lg:col-span-2 lg:order-first">
                      <img
                        className="w-20 lg:w-[50rem] mx-auto"
                        src={"https://www.btcin.in/tokenLogoSmall.svg"}
                        alt=""
                      />
                    </div>
                  </div>
