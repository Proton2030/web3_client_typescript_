  ...
  const fetchLevelUsers = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        `http://13.235.76.30:8989/api/levelUsers/${user.data.data?.referralCode}/3`
      );
    ...
    switch (platform) {
      ...
      case "twitter":
        ...
        shareLink = `https://twitter.com/intent/tweet?url=${encodeURIComponent(
          ...
          "Check out this referral link: " + referralCode
        )}`;
        break;
      case "instagram":
        // Replace the URL and text with your desired URL and text
        shareLink = `https://www.instagram.com/?url=${encodeURIComponent(
          "https://example.com"
        )}`;
        break;
      case "telegram":
    ...
    <>
      <main className={styles.main}>
        ...
        <div className={styles.wrapper}>
          <div
            className="w-full md:max-w-3xl md:w-[40rem] mx-auto -mt-32 relative overflow-hidden z-10
            ...
            <div className="" onClick={openModal}>
              ...
              <div className="mb-7  flex gap-5 w-full px-5 py-4 rounded-xl justify-between border border-gray-500">
                <div className="flex items-center text-gray-300">
                  <div className="text-xs md:text-xl md:mr-8 font-semibold">
                    Total Referrals:
                  </div>
                          ...
                          parsedLevel > 0 && (
                            ...
                            >
                              ...
                              <td className="px-6 py-4">
                                ...
                                {
                                  levelUsers[level].filter(
                                    (user: { is_active: any }) => user.is_active
                                  ).length
                                }
                              </td>
                            </tr>
                ...
                >
                  <div className="">
                    <div className="bg-gray-800 mx-4 p-4 rounded-xl w-full ">
                      <div className="flex justify-between items center border-b-2 border-gray-600 py-3">
