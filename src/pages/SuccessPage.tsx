...
// alert('Payment Successful! Transaction Hash: ');
  ...
  return (
    <div className='flex  justify-between items-center h-screen w-full'>
      <div
  className="cursor-pointer mx-auto group overflow-hidden p-5 duration-1000 hover:duration-1000 relative w-[30%] h-96 bg-neutral-800 rounded-xl"
>
  <div
  ...
  >
    <span className="text-neutral-50 font-bold text-xl italic">payment Succesfull</span>
